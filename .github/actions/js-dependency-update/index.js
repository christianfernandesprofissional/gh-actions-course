...
async function run() {
  ...
  if (!validateDirectoryName({ dirName: workingDir })) {
    ...
    core.info(`[js-dependency-update] : target is ${targetBranch}`);
  ...
  if (gitStatus.stdout.length > 0){
    ...
    core.info('[js-dependency-update]: No updates available at this point in time!');
  }
    ...
    4. if there are modified files:
        ...
        4.2 create a PR to the base-branch using the ocktokit API
